export const projectSeeds = [
  ...
  },
  {
    ...
    clientOrCompany: "Northstar SaaS",
    duration: "3 weeks",
    featured: true,
    gallery: [
      {
    ...
    projectUrl: "https://portfolio-rizal.dev/projects/northstar-sales-kit",
    role: "Frontend Lead",
    ...
    tags: ["Marketing Experience", "Northstar SaaS", "Frontend Lead"],
    techStack: ["Next.js", "Contentful", "Framer Motion", "Figma"],
    thumbnailPlaceholder: "Northstar Sales Kit cover frame",
  ...
  },
  {
    ...
    clientOrCompany: "Atlas Logistics",
    duration: "5 weeks",
    featured: false,
    gallery: [
      {
    ...
    projectUrl: "https://portfolio-rizal.dev/projects/atlas-ops-dashboard",
    role: "UI Engineer",
    ...
    tags: ["Internal Tooling", "Atlas Logistics", "UI Engineer"],
    techStack: ["React", "TypeScript", "Charts", "Design Tokens"],
    thumbnailPlaceholder: "Atlas Ops Dashboard cover frame",
